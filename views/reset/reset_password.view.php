...
<div class="container d-flex justify-content-center p-5">
    <div class="card p-5 col-8">
        <form action="../../controllers/reset/reset_password_condition.controller.php" method="post" name="signupForm" id="signupForm">
            ...
            <div class="button-wrapper text-center mt-3 d-flex justify-content-end">
                <button type="submit" id="submitButton" onclick="validateSignupForm()" class="btn btn-primary " href='/reset'>Change<span id="loader"></span>
                </button>
            </div>
