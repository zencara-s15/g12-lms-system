            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mb-2">
                        <input type="text" name="search_employee" id="search_employee" placeholder="Search employee..."
                            class="form-control" />
                    </div>
                    <!-- filter -->
                    <div class="col-md-4 mb-2">
                        <select id="position" name="position" class="custom-select  border-dark"
                            tile="Please select the position of the employee." required>
                ...
                <tbody>
                    ...
                    <tr class="border-bottom" style="font-size:14px">
                        <td class="d-flex" style="text-align: center; vertical-align: middle;">
                            <img style="width: 60px; object-fit: cover;" class="shadow-none rounded-circle"
                                alt="avatar1"
                                src="<?= 'data:image/jpeg;base64,' . base64_encode($employee['image_data']) ?>" />
                            <span
                                class="mt-3 m-lg-3"><?= $employee['first_name'] . " " . $employee['last_name'] ?></span>
                        </td>
                        ...
                        <td style="vertical-align: middle;">
                            ...
                            <a href="#" onclick="openDeleteModal(<?php echo $employee['id']; ?>)"
                                class="btn btn-danger border border-0" style="font-size:13px">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
