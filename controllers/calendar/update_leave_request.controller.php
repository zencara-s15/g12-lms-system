...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $id = $_POST['id'];
    $leave_type_update = $_POST['leave_type_id'];
    $description_update = $_POST['description_update'];
    $start_date_update = $_POST['start_date_update'];
    ...
    $start = new DateTime($start_date_update);
    $end = new DateTime($end_date_update);
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='details'>
                            ...
                            <p><strong>Leave Type:</strong> $leave_type_update</p>
                            <p><strong>Start Date:</strong> $start_date_update</p>
                            <p><strong>End Date:</strong> $end_date_update</p>
                            <p><strong>Duration:</strong> $duration Days</p>
                            <p><strong>Description:</strong> $description_update</p>
                        </div>
                        <div class='footer'>
