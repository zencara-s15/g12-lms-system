...
if(isset($_FILES['profile']) && $_FILES['profile']['error'] === UPLOAD_ERR_OK){
    ...
    $notification = $isCreate ? 'Employee has been created successfully.' : 'Failed to create employee.';
    $redirectUrl = $isCreate ? "/employees" : "/create_employee";
}
?>

<!--card alert tell the admin user-->
